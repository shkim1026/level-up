...
export default function Header() {
  ...
  return (
    <>
      {promoBannerIsOpen && (
        <div className="promoBanner z-30">
          <a href="/apparel">
      ...
      <header className="sticky top-0 z-40 lg:relative">
        <nav>
          {/* Mobile Navigation */}
          <div className="relative flex items-center justify-between bg-white h-16 lg:hidden border-b border-gray-300">
          ...
          {/* Desktop navigation */}
          <div className="bg-white hidden lg:block border-b border-gray-300 z-50">
            ...
            {isSearchBarOpen && (
              <>
                ...
                <motion.div 
                  ...
                  aria-modal="true"
                  aria-label="Search"
                  className="flex items-center justify-between absolute top-full left-0 w-full py-5 px-6 sm:px-10 bg-white text-dark-gray z-50 border-b border-gray-200"
